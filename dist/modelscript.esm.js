...
//this supports, log/exponent, minmax/normalization and standardscaling
  ...
  columnScale(name, options = {}) {
    ...
    case 'standard':
      transforms = util$1.StandardScalerTransforms(scaleData);     
...
export { loadCSV, loadCSVURI, preprocessing, util$$1 as util, cross_validation$$1 as cross_validation, model_selection, calc$$1 as calc, ml$$1 as ml, nlp$$1 as nlp, csv$1 as csv, PD$$1 as PD, DataSet };
